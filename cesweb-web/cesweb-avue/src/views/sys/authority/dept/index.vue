      ...
      <template slot="left">
        <div class="filter-container">
          <el-button-group>
            ...
            <el-button v-if="deptManager_btn_del" type="primary" icon="delete" @click="handleDelete">删除</el-button>
          </el-button-group>
        </div>
        <el-tree class="filter-tree" v-loading="treeLoading" :data="treeData" :props="defaultProps" :filter-node-method="filterNode" node-key="id" highlight-current default-expand-all @node-click="getNodeData" />
      </template>
      <template slot="body">
...
const GR = GlobalRequest.server('/system/dept')
...
export default {
  ...
  methods: {
    getList() {
      GR.fetchTree(this.listQuery).then(response => {
    ...
    getNodeData(data) {
      ...
      GR.fetchObj(data.id).then(response => {

package cn.cesgroup.cesweb.monitor.trans.config;
...
public class ConfigReader {
	...
	public void setCompensateNotifyUrl(String compensateNotifyUrl) {
		this.compensateNotifyUrl = compensateNotifyUrl;
	}

	public void setCompensateAuto(boolean isCompensateAuto) {
		this.isCompensateAuto = isCompensateAuto;
	}

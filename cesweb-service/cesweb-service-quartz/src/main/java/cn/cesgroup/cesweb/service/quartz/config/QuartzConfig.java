...
import cn.cesgroup.cesweb.service.quartz.factory.AutowireCapableBeanJobFactory;

/**
 * <p>描述: </p>
 * <p>Company: Professional</p>
 * @author chanlong(陈龙)
 * @date Aug 19, 2020 10:12:18 AM
 * @version 1.0.2020
 */
@Configuration
...
public class QuartzConfig {
	...
	private void customize(SchedulerFactoryBean schedulerFactoryBean) {
		if (this.customizers != null) {
			Iterator<SchedulerFactoryBeanCustomizer> iterator = this.customizers.iterator();

			while (iterator.hasNext()) {
				SchedulerFactoryBeanCustomizer customizer = (SchedulerFactoryBeanCustomizer) iterator.next();

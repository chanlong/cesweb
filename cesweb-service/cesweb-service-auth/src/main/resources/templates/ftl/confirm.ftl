    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://www.cesgroup.com.cn">技术支持</a>
            </p>
            <p class="navbar-text navbar-right">
                <a target="_blank" href="https://www.cesgroup.com.cn">${user.username}</a>
            </p>
        </div>
    </div>
</nav>
<div style="padding-top: 80px;width: 300px; color: #555; margin:0px auto;">
    <form id='confirmationForm' name='confirmationForm' action="/oauth/authorize" method='post'>
        ...
        <p><a href="${app.website!''}" target="_blank">${app.appName!'未定义应用名称'}</a> 将获得以下权限：</p>
        <ul class="list-group">
...
<footer>
    <p>support by: chanlong</p>
    <p>email: <a href="mailto:chen.long@cesgroup.com.cn">chen.long@cesgroup.com.cn</a>.</p>
</footer>
</body>
</html>

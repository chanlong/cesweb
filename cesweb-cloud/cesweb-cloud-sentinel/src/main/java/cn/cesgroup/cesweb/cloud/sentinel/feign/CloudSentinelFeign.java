package cn.cesgroup.cesweb.cloud.sentinel.feign;
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				private Object getFromContext(String name, String type, Class<?> fallbackType, Class<?> targetType) {
					...
					if (fallbackInstance == null) {
						String msg = "No %s instance of type %s found for feign client %s";
						throw new IllegalStateException(String.format(msg, type, fallbackType, name));
					}

					if (!targetType.isAssignableFrom(fallbackType)) {
						String msg = "Incompatible %s instance. Fallback/fallbackFactory of type %s is not assignable to %s for feign client %s";
						throw new IllegalStateException(String.format(msg, type, fallbackType, targetType, name));
					}
